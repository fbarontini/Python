...
def get_pefin(s):
	...
	while t != -1:
		...
		dic = {}
		dic['data']			 = to_date(s[t+a:t+b])
		dic['modalidade']	 = s[t+b:t+c].strip()
		dic['aval']			 = s[t+c:t+d].strip()
		dic['valor']		 = to_int(s[t+d:t+e])
		dic['contrato']		 = s[t+e:t+f].strip()
		dic['origem']		 = s[t+f:t+g].strip()
		dic['outros_a']		 = s[t+g:t+h].strip()
		dic['natureza']		 = s[t+h:t+i].strip()
		dic['outros_b']		 = s[t+i:t+j].strip()
		dic['vl_total']		 = to_int(s[t+j:t+k])
